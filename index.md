...
img: main-social.jpg
---
<section class="banner-section" style="background-image: url(../img/abhi-rose.webp);">
	<div class="wrap wrap-center ">
		<div class="wrap_float">
			<div class="section-content">
				<div class="location">#GovTech & finance entrepreneur, public servant & scholar. </div>
				<h2 class="page-title">
					Leveraging technology and data for the public good.
				</h2>
				<div class="socials">
				...
				<div class="accordion-block with-border">
					<div class="accordion-item opened">
						...
						<div class="accordion-item-content"  style="display: block;">
							<p>From co-founding Code for America to serving as LA's first Chief Data Officer — and from founding startups to leading product at Euna Solutions — there's a <strong><a href="/cv/">track record of 15+ years</a></strong> building and shaping the government technology field from every angle.
							<br></p>
						</div> 
					</div>
					...
					<div class="accordion-item">
						<div class="accordion-item-title">
							<span>
								Advisor: Supporting GovTech Growth
							</span>
						</div>
						<div class="accordion-item-content">
