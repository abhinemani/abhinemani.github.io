...
Why? Based on dozens of interviews in the summer and fall of 2021 with CIOs, CTOs, and other departmental heads, over the last ten years three trends have been fundamentally changing the buyer landscape in government technology: new leadership, personnel turnover, and SaaS expectations. And indeed the pandemic accelerated those drivers. Together, these demand-side shifts not only promise continued growth for the industry, but also more activity, innovation, and competition in the marketplace.
