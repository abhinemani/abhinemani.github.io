...
That commons is eroding. Not through scandal or collapse, but through something quieter — closer to what [Robert Putnam](https://en.wikipedia.org/wiki/Robert_D._Putnam) described a quarter-century ago: **the activity remains, but the institutions around it thin out.**
...
Software is entering its own bowling-alone moment. Developers are writing more code than ever, with astonishingly capable tools. But the forums, public repositories, mailing lists, and code reviews that surrounded that work are thinning. **The output looks healthy. The social layer is eroding.**
...
The early web inverted a long-standing rule: building anything significant used to require institutional permission. Then a teenager could open a pull request against a senior engineer at Google, argue about API design, and sometimes win. Status came from contribution. Reputation accumulated in public. That produced more than code. It produced institutions — [open source](https://opensource.org/), [Wikipedia](https://www.wikipedia.org/), the [IETF](https://www.ietf.org/), [Stack Overflow](https://stackoverflow.com/), [Code for America](https://codeforamerica.org/) — among the most functional of the early 21st century.
...
A person learned what a good bug report looked like. How to ask a question without wasting other people’s time. Why backward compatibility was moral as much as technical. Why “working” was not the same as “ready.” That cleverness was not the same as stewardship.
...
The most useful thing about Putnam’s later work, [*The Upswing*](https://www.simonandschuster.com/books/The-Upswing/Robert-D-Putnam/9781982129156), is that it refuses to end where [*Bowling Alone*](https://www.simonandschuster.com/books/Bowling-Alone-Revised-and-Updated/Robert-D-Putnam/9781982130848) did. Civic infrastructure is not inherited. It is built. Settlement houses, public libraries, PTAs, labor unions — they were created by people who saw what was missing and decided to make it.

Software’s “we” period was built too. Open-source norms, code review culture, Stack Overflow, hackathons, civic tech brigades — they were civic inventions. If they are eroding, the answer is not nostalgia. **It is institution-building.**
...
That requires a different definition of productivity. If the only thing we measure is how quickly an individual can turn an idea into code, then AI will make the old social practices look irrational. Why wait for review? Why ask in public? Why pair with another person? Why write the explanatory post? The answer is that those practices were never only about the immediate task. **They were the mechanisms by which the profession renewed itself.**

Rebuilding the leagues, then, does not mean recreating 2012 Stack Overflow or pretending open source can run forever on heroic volunteer labor. It means designing new defaults: teams that make AI-generated work reviewable; communities that reward explanation, not just output; public-interest projects that treat documentation and maintainership as core work; and institutions that make it easier for newcomers to become contributors rather than merely users of increasingly powerful tools.

Hackathons become more valuable, not less, precisely because they are no longer necessary. Pair programming becomes valuable as teaching, not productivity. Open source becomes stewardship, not free labor. Code review becomes cultural transmission. Middle-ring relationships have to be cultivated deliberately, because they no longer form by accident.

This is especially true in civic tech, where the work was never only about shipping products. The point was to build a different relationship between institutions and the people they served, and to do that by bringing people into the work itself. The brigade, the hack night, the volunteer project, the open data portal, the public GitHub repo — these were not always efficient. Sometimes they were maddeningly inefficient. But they created an invitation. They told people that government and technology were not sealed systems. They could be entered, questioned, improved.

That lesson feels newly important. AI can make a single person much more capable, but capacity is not the same as legitimacy. Public-interest technology still depends on people learning how to work with strangers across institutions, disciplines, and levels of authority. It depends on trust. And trust is not generated by private productivity. It is generated by repeated participation in shared work.
