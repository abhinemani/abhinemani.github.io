...
subhead: How to build realistic models for valuations in local government technology
categories: Academy
pubdate: 2021
img: pia-header.png
pubdate: Updated 2025
number: 2
...
Instead of assuming every government eventually buys something at the same price, bottom-up sizing uses:

* real counts of governments
* different prices by tier
* different adoption rates by tier
